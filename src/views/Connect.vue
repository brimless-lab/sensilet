<template>
    <div class="panel">
        <div class="title">允许此网站访问您的账户信息吗？</div>
        <div class="link-info">
            <div class="origin">{{origin}}</div>
            <svg t="1624589235932" class="icon" width="32" height="32" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2685" data-spm-anchor-id="a313x.7781069.0.i3">
            ...
            <div class="account-info">
                <div class="account">Main Account</div>
                <div class="address">{{address}}</div>
            </div>
        </div>
        <div class="notice">只链接您信任的网站</div>
        <div class="action-container" v-if="!isConnecting">
            <a-button @click="cancel">取消</a-button>
            <a-button type="primary" @click="connect">链接</a-button>
        </div>
            <a-spin  v-else/>
    </div>
</template>
